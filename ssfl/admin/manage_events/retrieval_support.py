...
class Evt(object):
    ...
    def __init__(self, id, event_name, event_description, event_cost, event_sign_up, hl_pick_up, ec_pickup,
                 all_day, event_occurs, event_start, event_end, event_location):
        self.id = id
...
class EventsInPeriod(object):
    ...
    def __init__(self, db_session, start_time: dt.datetime, end_time: dt.datetime, audiences: list, categories: list):
        ...
        all_events = []
        for id, name, desc, cost, signup, ec_pickup, hl_pickup, start, end, all_day, location in res.fetchall():
            evt = Evt(id, name, desc, cost, signup, hl_pickup, ec_pickup, all_day, 'x', start, end, location)
